 ...
 * Date : 28th,June
 * Name : Justina
 * Content : to practice Regular Expression
 */
...
public class RegularExpressionTest {
	...
	String strPatt = "a[a-z]*";   //* 와일드카드. 시작은 a로 시작하되 다음은 영어소문자 하나이상이 나와야한다
	...
	//정규표현식 패턴
	String[] patterns = {//배열의 이름은 S를 붙이는 것이 관례
							"[0-9]+",  //숫자 1개 이상 
							"1[0-9]*",//1로 시작하는 숫자 0개 이상
							"^[0-9]",  //숫자로 시작하는 문자^ 는 캐럿이라고 한다 시작문자 | 정규표현식안에 있으면 not
							"[^0-9]",//숫자가 아닌 문자
							".",				//문자1개
							"[a-z]?",   	 //영어 소문자1개 
							"[a-z]*",		//영어 소문자 0개 이상
