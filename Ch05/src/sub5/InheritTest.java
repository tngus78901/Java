 ...
 * Date : 21st,June.2023	
 * Name : Justina
 * Content : Java 클래스 상속 실습하기
 * 
 * 
 * 상속(Inheritance)
 *  - 기존 클래스의 속성과 기능을 그대로 자식 클래스에게 확장시키는 프로그래밍 문법 /키워드 extends
...
public class InheritTest {
	public static void main(String[] args) {
		...
		//상속 객체 생성
		Child c1 = new Child(1,2,3,4);  //child는 참조변수
		int rs1 = c1.plus();
		int rs2 = c1.minus();
		...
		//Account 상속객체 생성
		StockAccount kb = new StockAccount("KB증권", "101-11-1234", "홍길동",10000,"삼성전자",10,60000);
		kb.deposit(1000000);
		kb.buy(5, 58000);
		kb.sell(5, 620000);
