...
public class EncapsuleTest {
		 ...
		 public static void main(String[] args) {
			 ...
			 //Car 객체 생성 초기화
			 Car sonata = new Car("소나타", "흰색", 10); //생성자호출
			 sonata.setName("그랜져");
			 sonata.speedUp(80);
			 sonata.speedDown(20);
			 sonata.show();
			 ...
			 //Account 객체 생성 초기화
			 Account kb = new Account ("국민은행" , "101-545-7878", "김유신", 10000);
			 kb.deposit(40000);
			 kb.withdraw(25000);
			 kb.show();
			 
			//Account 객체 생성 초기화
			 Account wr = new Account("우리은행", "101-87454-578", "김춘추", 1000);
			 wr.deposit(30000);
			 wr.withdraw(5000);
			 wr.show();
		}
